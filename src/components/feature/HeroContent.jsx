...
function HeroContent() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-3 sm:px-6 text-center">
      ...
      <h1 className="hero-title text-xl sm:text-4xl md:text-5xl lg:text-6xl text-white mb-3 sm:mb-4">
        Find Your Perfect Hotel
      </h1>
      <p className="hero-subtitle text-sm sm:text-lg md:text-xl text-white/90 mb-6 sm:mb-8 sm:mb-10 px-2 sm:px-0">
