...
import { 
  Heart, Star, MapPin, Clock, Users, Globe, Eye, Sparkles
} from 'lucide-react';
...
const ActivityCard = ({ activity, onFavoriteToggle, isFavorite, onViewDetails }) => {
  ...
  const defaultImage = 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?w=400&h=300&fit=crop&crop=center';
  ...
  return (
    <motion.div
      ...
      className="group bg-gradient-to-br from-white via-white to-gray-50/50 rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-700 border border-gray-200/50 relative cursor-pointer backdrop-blur-sm w-full h-full flex flex-col"
    ...
    >
      ...
      <div className="relative overflow-hidden flex-shrink-0">
        <div className="aspect-w-16 aspect-h-10">
          <img
            ...
            alt={activity.title}
            className="w-full h-48 sm:h-52 md:h-56 lg:h-60 object-cover group-hover:scale-110 transition-transform duration-700 filter group-hover:brightness-110"
          />
        </div>
      ...
      {/* Content */}
      <div className="p-4 sm:p-6 lg:p-8 relative flex-1 flex flex-col">
        ...
        <div className="relative z-10 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mb-4 sm:mb-6 flex-shrink-0">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-xs sm:text-sm text-gray-500 font-medium hidden sm:block">(128 reviews)</span>
              <span className="text-xs text-gray-500 font-medium sm:hidden">(128)</span>
            </div>
