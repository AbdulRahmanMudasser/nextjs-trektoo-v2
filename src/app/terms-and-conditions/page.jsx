...
import { ArrowLeft, Shield, FileText, AlertTriangle, CheckCircle, Globe, Scale, Clock, Users } from 'lucide-react';
  ...
  const termsSection = [
    {
      ...
      content: "By accessing and using Trektoo's services, you accept and agree to be bound by the terms and provision of this agreement. These Terms and Conditions constitute the entire agreement between you and Trek Too LTD.",
      gradient: "from-blue-500 to-cyan-600"
    },
    {
      icon: Users,
      title: "2. Use of Services",
      content: "Our platform provides travel booking services including flights, hotels, and travel insurance. You agree to use our services only for lawful purposes and in accordance with these Terms. You are responsible for ensuring the accuracy of all information provided during booking.",
      gradient: "from-emerald-500 to-teal-600"
    },
    {
      icon: Shield,
      title: "3. User Accounts",
      content: "To access certain features, you may need to create an account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account. Notify us immediately of any unauthorized use.",
      gradient: "from-purple-500 to-violet-600"
    },
    {
      icon: Globe,
      title: "4. Booking and Payment",
      content: "All bookings are subject to availability and confirmation. Prices may change without notice until booking is confirmed. Payment must be made in full at the time of booking. We accept various payment methods as displayed on our platform.",
      gradient: "from-orange-500 to-red-600"
    },
    {
      icon: AlertTriangle,
      title: "5. Cancellation and Refunds",
      content: "Cancellation policies vary by service provider and booking type. Refund eligibility depends on the specific terms of your booking. Processing fees may apply to cancellations. Please review individual booking terms before confirming your reservation.",
      gradient: "from-yellow-500 to-orange-600"
    },
    {
      icon: Scale,
      title: "6. Limitation of Liability",
      content: "Trek Too LTD acts as an intermediary between you and service providers. We are not liable for any direct, indirect, incidental, or consequential damages arising from your use of our services or any travel-related issues beyond our control.",
      gradient: "from-red-500 to-pink-600"
    },
    {
      icon: Clock,
      title: "7. Force Majeure",
      content: "We are not responsible for any failure to perform our obligations due to circumstances beyond our reasonable control, including but not limited to natural disasters, government actions, strikes, or other unforeseeable events.",
      gradient: "from-indigo-500 to-blue-600"
    },
    {
      icon: CheckCircle,
      title: "8. Privacy and Data Protection",
      content: "We collect and process personal data in accordance with our Privacy Policy and applicable data protection laws. Your personal information is used solely for providing our services and improving your travel experience.",
  ...
  const additionalTerms = [
    {
      ...
      content: "All content on our platform, including logos, text, images, and software, is owned by Trek Too LTD and protected by intellectual property laws. Unauthorized use is prohibited."
    },
    {
      title: "Third-Party Services",
      content: "Our platform may contain links to third-party websites or services. We are not responsible for the content, privacy policies, or practices of these third parties."
    },
    {
      title: "Modifications to Terms",
      content: "We reserve the right to modify these Terms and Conditions at any time. Changes will be effective immediately upon posting. Continued use of our services constitutes acceptance of modified terms."
    },
    {
      title: "Governing Law",
    ...
    },
    {
      ...
      content: "If you have any questions about these Terms and Conditions, please contact us at info@trektoo.com or call our customer service at +44 7308 656687."
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-10 md:p-12">
              ...
              <div className="bg-gradient-to-br from-gray-50 to-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <p className="text-lg text-gray-700 leading-relaxed mb-4">
                  This agreement is between you and <span className="font-bold text-blue-600">Trek Too LTD</span>, a company registered in England and Wales (Company No: 15766570). 
                </p>
          ...
          <div className="space-y-8 mb-12">
            {termsSection.map((section, index) => (
              ...
              >
                <div className={`absolute inset-0 bg-gradient-to-r ${section.gradient} opacity-5 rounded-3xl blur-xl group-hover:opacity-10 transition-all duration-500`}></div>
                <div className="relative bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 p-8 md:p-10">
                  <div className="flex items-start mb-6">
                    <div className={`bg-gradient-to-br ${section.gradient} p-4 rounded-2xl shadow-lg mr-6 flex-shrink-0`}>
            ...
            <div className="relative bg-gradient-to-br from-yellow-500 via-orange-500 to-red-600 rounded-3xl p-12 text-white shadow-2xl border border-yellow-400/50">
              <div className="text-center">
                ...
                <p className="text-xl text-yellow-100 mb-6 max-w-3xl mx-auto">
                  These terms are legally binding. If you do not agree with any part of these terms, please do not use our services. For questions or clarifications, contact our legal team.
                </p>
