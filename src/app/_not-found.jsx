          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <motion.div className="w-full md:w-1/2" variants={itemVariants}>
              <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] overflow-hidden rounded-2xl shadow-lg">
                <Image
                  ...
                  loading="lazy"
                  placeholder="blur"
                  blurDataURL="/images/404-not-found-placeholder.jpg"
                />
                <motion.div
            ...
            >
              ...
              <motion.div variants={itemVariants}>
                <Link href="/">
                  <motion.a
                    className="inline-block bg-blue-500 text-white font-semibold px-5 sm:px-8 py-2 sm:py-2.5 rounded-lg hover:bg-blue-600 transition-all duration-300 text-sm sm:text-base shadow-md"
                    style={{ fontFamily: "'Lora', serif" }}
                    whileHover={{
                      scale: 1.05,
